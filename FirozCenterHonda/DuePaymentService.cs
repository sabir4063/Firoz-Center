namespace FirozCenterHonda
{
    ...
    public class DuePaymentService : Form
    {
        ...
        public DuePaymentService(string memo_no)
        {
            this.dbc = new DBConnect();
            this.components = null;
            this.InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxMemoNo.TextChanged += new EventHandler(this.textBoxMemoNo_TextChanged);
            ...
            base.ClientSize = new Size(370, 0x128);
            base.Controls.Add(this.groupBox4);
            base.Controls.Add(this.groupBox1);
            //base.FormBorderStyle = FormBorderStyle.FixedToolWindow;
            base.Name = "DuePaymentService";
            this.Text = "DuePaymentService";
        ...
        private void load_transcation()
        {
            ...
            string query = "Select net_amount,customer_id,type,paid_amount,due_amount from firoz_center.tbl_sales_service where memo_no='" + text + "';";
        ...
        private void save_transcation()
        {
            ...
            string query = "Select customer_id from firoz_center.tbl_sales_service where memo_no='" + str4 + "';";
            ...
            string str9 = "insert into firoz_center.tbl_transcation (`memo_no`,`debit`,`user_id`,`description`,`date`) values ('" + str4 + "','" + text + "','1','Due Service','" + str5 + "');";
            this.dbc.Insert(str9);
            str8 = string.Concat(new object[] { "UPDATE firoz_center.tbl_sales_service set paid_amount='", num, "',due_amount='", str3, "' where memo_no='", str4, "';" });
        ...
        private void textBoxMemoNo_TextChanged(object sender, EventArgs e)
        {
        }
