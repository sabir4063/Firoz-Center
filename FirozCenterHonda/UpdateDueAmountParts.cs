namespace FirozCenterHonda
{
    ...
    public class UpdateDueAmountParts : Form
    {
        ...
        public UpdateDueAmountParts(string m, string date, string amount, string memo_no)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            base.Dispose();
            new DuePaymentEditParts(this.memo_no).Show();
        }
        ...
        private void InitializeComponent()
        {
            ...
            base.ClientSize = new Size(0x14c, 90);
            base.Controls.Add(this.groupBox1);
            base.FormBorderStyle = FormBorderStyle.SizableToolWindow;
            base.Name = "UpdateDueAmountParts";
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "UpdateDueAmountParts";
