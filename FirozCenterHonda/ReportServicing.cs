...
{
    public partial class ReportServicing : Form
    {
        public ReportServicing()
        {
            InitializeComponent();
        }
            ...
            for (num = 0; num < listArray[0].Count; num++)
            {
                ...
                {                    
                    ...
                    if (dt >= start_dt && dt <= end_dt)
                    {
                        ...
                        else if(radioButton2.Checked.Equals(true) && count==-1)
                            this.dataGridView1.Rows.Add(new object[] { date, memo_no, name, contact, i });
                        else if (radioButton3.Checked.Equals(true) && count != -1)
                            this.dataGridView1.Rows.Add(new object[] { date, memo_no, name, contact, i });
                    }
                }
            }
        ...
        {
            ServicingDetails SD = new ServicingDetails(this.dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString(), this.dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString(), this.dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString(), this.dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString());
            SD.Show();
        }
