namespace FirozCenterHonda.teDataSetTableAdapters
{
    ...
    public class tbl_party_transcationTableAdapter : Component
    {
        ...
        public tbl_party_transcationTableAdapter()
        {
        ...
        public virtual int Delete(uint p1, uint p2, DateTime p3, double p4, string p5, string p6, string p7, string p8)
        {
            int num2;
        ...
        public virtual int Fill(teDataSet.tbl_party_transcationDataTable dataTable)
        {
        ...
        public virtual teDataSet.tbl_party_transcationDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            teDataSet.tbl_party_transcationDataTable dataTable = new teDataSet.tbl_party_transcationDataTable();
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "SELECT `transcation_id`, `party_id`, `date`, `amount`, `description`, `type`, `details`, `invoice_no` FROM `tbl_party_transcation`";
        ...
        public virtual int Insert(uint p1, DateTime p2, double p3, string p4, string p5, string p6, string p7)
        {
            int num2;
        ...
        {
            return this.Adapter.Update(dataSet, "tbl_party_transcation");
        }

        [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode]
        public virtual int Update(teDataSet.tbl_party_transcationDataTable dataTable)
        {
        ...
        public virtual int Update(uint p1, DateTime p2, double p3, string p4, string p5, string p6, string p7, uint p8, uint p9, DateTime p10, double p11, string p12, string p13, string p14, string p15)
        {
            int num2;
