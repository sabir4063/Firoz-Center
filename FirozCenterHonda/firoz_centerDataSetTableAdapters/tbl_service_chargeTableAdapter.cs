namespace FirozCenterHonda.teDataSetTableAdapters
{
    ...
    public class tbl_service_chargeTableAdapter : Component
    {
        ...
        public tbl_service_chargeTableAdapter()
        {
        ...
        public virtual int Delete(uint p1, string p2, string p3, double p4)
        {
            int num2;
        ...
        public virtual int Fill(teDataSet.tbl_service_chargeDataTable dataTable)
        {
        ...
        public virtual teDataSet.tbl_service_chargeDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            teDataSet.tbl_service_chargeDataTable dataTable = new teDataSet.tbl_service_chargeDataTable();
        ...
        private void InitAdapter()
        {
            ...
            DataTableMapping mapping = new DataTableMapping {
                SourceTable = "Table",
                DataSetTable = "tbl_service_charge",
                ColumnMappings = { 
                    { 
                        "service_id",
                        "service_id"
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `tbl_service_charge` WHERE ((`service_id` = @p1) AND (`name` = @p2) AND (`description` = @p3) AND (`charge` = @p4))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `tbl_service_charge` (`name`, `description`, `charge`) VALUES (@p1, @p2, @p3)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `tbl_service_charge` SET `name` = @p1, `description` = @p2, `charge` = @p3 WHERE ((`service_id` = @p4) AND (`name` = @p5) AND (`description` = @p6) AND (`charge` = @p7))";
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "SELECT `service_id`, `name`, `description`, `charge` FROM `tbl_service_charge`";
        ...
        public virtual int Insert(string p1, string p2, double p3)
        {
            int num2;
            if (p1 == null)
            {
        ...
        {
            return this.Adapter.Update(dataSet, "tbl_service_charge");
        }

        [HelpKeyword("vs.data.TableAdapter"), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode]
        public virtual int Update(teDataSet.tbl_service_chargeDataTable dataTable)
        {
        ...
        public virtual int Update(string p1, string p2, double p3, uint p4, string p5, string p6, double p7)
        {
            int num2;
            if (p1 == null)
            {
