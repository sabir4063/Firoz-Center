namespace FirozCenterHonda
{
    ...
    public class DuePaymentEditParts : Form
    {
        ...
        public DuePaymentEditParts(string memo_no)
        {
            this.dbc = new DBConnect();
            this.total = 0L;
            this.components = null;
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE firoz_center.tbl_sales_parts set due_amount='" + text + "', paid_amount='" + str + "' where memo_no='" + this.textBoxMemoNo.Text + "';";
        ...
        private void dataGridView1_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            new UpdateDueAmountParts(m, date, amount, text).Show();
            base.Dispose();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.buttonSave.Location = new Point(0x83, 310);
            this.buttonSave.Name = "buttonSave";
            this.buttonSave.Size = new Size(120, 30);
            this.buttonSave.TabIndex = 0x1f;
            ...
            base.ClientSize = new Size(0x179, 0x157);
            base.Controls.Add(this.buttonSave);
            base.Controls.Add(this.groupBox1);
            //base.FormBorderStyle = FormBorderStyle.FixedToolWindow;
            base.Name = "DuePaymentEditParts";
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "DueEditParts";
        ...
        private void load_transcation()
        {
            ...
            string text = this.textBoxMemoNo.Text;
            string query = "Select grand_total,customer_id,type,due_amount from firoz_center.tbl_sales_parts where memo_no='" + text + "';";
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.textBoxPrice.Text = listArray[0].ElementAt<string>(0);
                    this.textBoxDue.Text = listArray[3].ElementAt<string>(0);
                    string str4 = "Select payment_id,DATE_FORMAT(date, '%Y-%m-%d') AS date1,amount FROM firoz_center.tbl_payment where memo_no='" + text + "';";
                    List<string>[] listArray2 = new List<string>[3];
                    for (num2 = 0; num2 < 3; num2++)
                    {
                        listArray2[num2] = new List<string>();
                    }
                    listArray2 = this.dbc.Select(3L, str4);
