namespace FirozCenterHonda
{
    ...
    public class ReportMonthlySalesEngineOil : Form
    {
        ...
        public ReportMonthlySalesEngineOil()
        {
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            string query = "Select memo_no,grand_total,customer_id,DATE_FORMAT(date, '%d-%m-%Y') AS date,paid_amount,due_amount from firoz_center.tbl_sales_parts where date between '" + str + "' and '" + str2 + "' and type='Sales Engine Oil'";
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // ReportMonthlySalesEngineOil
            // 
            this.BackColor = System.Drawing.Color.MediumSeaGreen;
            this.ClientSize = new System.Drawing.Size(889, 456);
            this.Controls.Add(this.groupBox1);
            this.Name = "ReportMonthlySalesEngineOil";
            this.Text = "Report Monthly Sales Engine Oil";
            ...
            try
            {
                ...
                while (this.iRow <= (this.dataGridView1.Rows.Count - 1))
                {
                    ...
                    if (this.bNewPage)
                    {
                        ...
                        y += 0x19;
                        e.Graphics.DrawString("Monthly Sales Report: Engine Oil", font4, brush, new Rectangle(15, y, 800, font4.Height), this.sfMiddle);
                        y += 20;
