namespace FirozCenterHonda
{
    ...
    public class DueReport : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridView1.Location = new Point(6, 0x41);
            this.dataGridView1.Name = "dataGridView1";
            this.dataGridView1.ReadOnly = true;
            this.dataGridView1.Size = new Size(0x34c, 0x1a1);
            ...
            this.groupBox1.Size = new Size(0x358, 0x1e8);
            this.groupBox1.TabIndex = 3;
            this.groupBox1.TabStop = false;
            this.groupBox1.Text = "Due Report";
            this.panel1.BackColor = Color.MediumSeaGreen;
            this.panel1.Controls.Add(this.radioButton3);
            this.panel1.Controls.Add(this.radioButton2);
            this.panel1.Controls.Add(this.radioButton1);
            this.panel1.Location = new Point(0x16, 0x16);
            this.panel1.Name = "panel1";
            this.panel1.Size = new Size(0x32c, 0x25);
            this.panel1.TabIndex = 0x25;
            this.radioButton2.AutoSize = true;
            this.radioButton2.Location = new Point(0x17e, 8);
            this.radioButton2.Name = "radioButton2";
            this.radioButton2.Size = new Size(0x4a, 20);
            ...
            this.radioButton1.Location = new Point(0x126, 8);
            this.radioButton1.Name = "radioButton1";
            this.radioButton1.Size = new Size(0x34, 20);
            this.radioButton1.TabIndex = 0;
            this.radioButton1.TabStop = true;
            this.radioButton1.Text = "BHL";
            ...
            this.buttonPrint.Location = new Point(0x182, 0x1f0);
            ...
            this.radioButton3.Location = new Point(0x1e5, 8);
            this.radioButton3.Name = "radioButton3";
            this.radioButton3.Size = new Size(0x31, 20);
            ...
            base.ClientSize = new Size(0x361, 0x20f);
        ...
        private void load_data(string tag)
        {
            ...
            {
                query = "Select memo_no,DATE_FORMAT(date, '%d-%m-%Y') AS date1,customer_id,grand_total,paid_amount,due_amount from firoz_center.tbl_sales_motorcycle where due_amount>0 order by date asc;";
            }
            else if (tag.Equals("Parts"))
            {
                query = "Select memo_no,DATE_FORMAT(date, '%d-%m-%Y') AS date1,customer_id,grand_total,paid_amount,due_amount from firoz_center.tbl_sales_parts where due_amount>0 order by date asc;";
            }
            else
            {
                query = "Select memo_no,DATE_FORMAT(date, '%d-%m-%Y') AS date1,customer_id,grand_total,paid_amount,due_amount from firoz_center.tbl_sales_service where due_amount>0 order by date asc;";
            }
            ...
            for (num = 0; num < listArray[0].Count; num++)
            {
                ...
                else if (this.radioButton2.Checked.Equals(true))
                {
                    if (!str3.Contains("BHL"))
                    {
                        this.dataGridView1.Rows.Add(new object[] { str3, listArray[0].ElementAt<string>(num), listArray[1].ElementAt<string>(num), listArray[3].ElementAt<string>(num), listArray[4].ElementAt<string>(num), listArray[5].ElementAt<string>(num) });
                ...
                num2 += double.Parse(listArray[3].ElementAt<string>(num));
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.load_data(this.tag);
            }
            else
            {
                MessageBox.Show("Only for Parts");
            }
        }
